...
import RelatedProducts from 'theme/components/product/Related.vue'
import Reviews from 'theme/components/product/Reviews.vue'
import AddToCart from 'theme/components/AddToCart.vue'
