  ...
  create (req, res) {
    ...
    for (let product of req.body.products) {
      ...
      if (!config.tax.usePlatformTotals) {
        /*
        * These two options (usePlatformTotals, alwaysSyncPlatformPricesOver) are used to determine whether to fetch
        * prices from data source on the fly or not.
        * If you set alwaysSyncPlatformPricesOver to true, then it skips checking the checksum for
        * cart items based on price.
        * */
