...
return [
    'modules' => [
        ...
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'AuroraExtensions_ModuleComponents' => 0,
        'AuroraExtensions_GoogleCloudStorage' => 0,
        'Divante_ReviewApi' => 1,
        'Divante_VsbridgeIndexerCore' => 1,
        'Divante_VsbridgeIndexerAgreement' => 1,
        'Divante_VsbridgeIndexerCatalog' => 1,
        'Divante_VsbridgeIndexerCms' => 1,
        'Divante_VsbridgeDownloadable' => 1,
        'Divante_VsbridgeIndexerReview' => 1,
        'Divante_VsbridgeIndexerTax' => 1,
        'Dotdigitalgroup_Email' => 1,
        'Dotdigitalgroup_Chat' => 1,
        'Inviqa_MessageQueueExample' => 0,
        'Klarna_Core' => 1,
        ...
        'VueStorefront_CartSync' => 1,
        'WebShopApps_MatrixRate' => 1,
        'WhiteDonkey_Checkout' => 1,
        'WhiteDonkey_Elastic' => 1,
        'WhiteDonkey_Indexer' => 1,
        'WhiteDonkey_MessageQueue' => 1,
        'WhiteDonkey_Messaging' => 0,
        'Windcave_Payments' => 1,
        'Yotpo_Yotpo' => 1
    ]
];
